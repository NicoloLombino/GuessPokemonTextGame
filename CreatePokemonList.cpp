...
std::vector<MyPokemon> CreatePkmnList()
{
	...
	MyPokemonList.push_back({ "Ivysaur", {grass, poison}, medium, {fourLegs, starter} });
	...
	MyPokemonList.push_back({ "Charmeleon", {fire}, medium, {twoLegs, starter, hasTail, hasArms} });
	...
	MyPokemonList.push_back({ "Wartortle", {water}, medium, {twoLegs, starter, hasTail, hasArms} });
	...
	MyPokemonList.push_back({ "Metapod", {bug}, medium, {noLegs} });
	...
	MyPokemonList.push_back({ "Kakuna", {bug, poison}, medium, {noLegs} });
	...
	MyPokemonList.push_back({ "Pidgeotto", {normal, flying}, medium, {twoLegs, hasTail} });
	...
	MyPokemonList.push_back({ "Spearow", {normal, flying}, base, {twoLegs, hasArms} });
	MyPokemonList.push_back({ "Fearow", {normal, flying}, final, {twoLegs, hasArms} });
	...
	MyPokemonList.push_back({ "Nidorina", {poison}, medium, {fourLegs, hasTail} });
	...
	MyPokemonList.push_back({ "Nidorino", {poison}, medium, {fourLegs} });
	...
	MyPokemonList.push_back({ "Gloom", {grass, poison}, medium, {twoLegs, hasArms} });
	...
	MyPokemonList.push_back({ "Poliwhirl", {water}, medium, {twoLegs, hasArms} });
	...
	MyPokemonList.push_back({ "Kadabra", {psychc}, medium, {twoLegs, hasTail, hasArms} });
	...
	MyPokemonList.push_back({ "Machoke", {fight}, medium, {twoLegs, hasArms} });
	MyPokemonList.push_back({ "Machamp", {fight}, final, {twoLegs, hasArms} });
	MyPokemonList.push_back({ "Bellsprout", {grass, poison}, base, {twoLegs} });
	MyPokemonList.push_back({ "Weepinbell", {grass, poison}, medium, {noLegs} });
	...
	MyPokemonList.push_back({ "Graveler", {rock, ground}, medium, {twoLegs, hasArms} });
	...
	MyPokemonList.push_back({ "Haunter", {ghost, poison}, medium, {noLegs, hasArms} });
	...
	MyPokemonList.push_back({ "Dragonair", {dragon}, medium, {noLegs, hasTail} });
